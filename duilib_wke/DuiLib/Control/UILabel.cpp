...
namespace DuiLib
{
	...
	void CLabelUI::PaintText(HDC hDC)
	{
		...
		else
		{
			...
			StringFormat format;
			StringAlignment sa = Gdiplus::StringAlignmentNear;
			if ((m_uTextStyle & DT_VCENTER) != 0) sa = Gdiplus::StringAlignmentCenter;
			else if( (m_uTextStyle & DT_BOTTOM) != 0) sa = Gdiplus::StringAlignmentFar;
			format.SetAlignment((StringAlignment)sa);
			sa = Gdiplus::StringAlignmentNear;
			if ((m_uTextStyle & DT_CENTER) != 0) sa = Gdiplus::StringAlignmentCenter;
			else if( (m_uTextStyle & DT_RIGHT) != 0) sa = Gdiplus::StringAlignmentFar;
